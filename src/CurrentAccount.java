...
public class CurrentAccount extends JDialog {
    ...
    public CurrentAccount() {
        ...
        buttonOK.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String MOTHERNAME = textField4.getText();
                String CNIC = textField5.getText();
                String TELEPHONENUMBER = textField14.getText();
                String MOBILENUMBER1 = textField15.getText();
                String NTNNUMBER = textField6.getText();
                String OCCUPATION = textField10.getText();
                String EMAILADDRESS = textField3.getText();
                String HOMEADDRESS = textField9.getText();
                String MOBILENUMBER2 = textField11.getText();
                String OFFICEADDRESS = textField8.getText();
                String RANK = textField12.getText();
                String GENDER;
                String BALANCE = "0";
                ...
                File F5 = new File(CNIC + "c.txt");
                File F6 = new File(CNIC + "d.txt");
                File F2 = new File(CNIC + "b.txt");
                if (F5.exists() || F6.exists() )
                {
                    JOptionPane.showMessageDialog(null,"THIS ID ALREADY HAVE A SAVING ACCOUNT");
                }
                else {
                    if (F2.exists() )
                    {
                    ...
                    try {
                        F2.createNewFile();
                        FileWriter f3 = new FileWriter(CNIC + "b.txt");
                        f3.write(BALANCE);
                        f3.close();
                    ...
                    else
                    {
                        ...
                        try {
                            FileWriter FA1 = new FileWriter(CNIC + "a.txt");
                            FA1.write("NAME: " + NAME);
    ...
    public static void main(String[] args) {
        CurrentAccount dialog = new CurrentAccount();
        dialog.pack();
